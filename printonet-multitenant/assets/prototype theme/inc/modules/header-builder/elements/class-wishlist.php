				...
				'text_design'         => array(
					...
					'options'   => array(
						'1' => array(
							'value' => '1',
							'label' => esc_html__( 'First', 'woodmart' ),
							'image' => WOODMART_ASSETS_IMAGES . '/header-builder/wishlist-icons/text-first.jpg',
						),
						'4' => array(
							'value' => '4',
							'label' => esc_html__( 'Second', 'woodmart' ),
							'image' => WOODMART_ASSETS_IMAGES . '/header-builder/wishlist-icons/text-second.jpg',
						),
						'6' => array(
							'value' => '6',
							'label' => esc_html__( 'Third', 'woodmart' ),
							'image' => WOODMART_ASSETS_IMAGES . '/header-builder/wishlist-icons/text-third.jpg',
						),
						'7' => array(
							'value' => '7',
							'label' => esc_html__( 'Fourth', 'woodmart' ),
							'image' => WOODMART_ASSETS_IMAGES . '/header-builder/wishlist-icons/text-fourth.jpg',
						),
					),
					'condition' => array(
						'design' => array(
