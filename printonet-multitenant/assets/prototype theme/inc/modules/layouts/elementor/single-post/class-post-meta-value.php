 ...
 */
class Post_Meta_Value extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_title() {
		return esc_html__( 'Post meta value', 'woodmart' );
	}
	...
	public function get_icon() {
		return 'wd-icon-post-meta-value';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'type'         => 'wd_css_class',
				'default'      => 'wd-single-post-meta-value',
				'prefix_class' => '',
			)
		);
...
Plugin::instance()->widgets_manager->register( new Post_Meta_Value() );
