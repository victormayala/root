 ...
 */
class Price_Tracker extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_title() {
		return esc_html__( 'Price tracker button', 'woodmart' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'type'         => 'wd_css_class',
				'default'      => 'wd-single-action-btn wd-single-pt-btn',
				'prefix_class' => '',
			)
		);
	...
	protected function render() {
		...
		$classes  = 'wd-action-btn wd-pt-icon';
		...
		$class_instance->render_button( $classes );

		Main::restore_preview();
	}
}

Plugin::instance()->widgets_manager->register( new Price_Tracker() );
