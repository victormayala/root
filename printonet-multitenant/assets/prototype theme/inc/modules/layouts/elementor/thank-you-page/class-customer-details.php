...
class Customer_Details extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Customer details', 'woodmart' );
	}
	...
	public function get_icon() {
		return 'wd-icon-tp-customer-details';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				'type'         => 'wd_css_class',
				'default'      => 'wd-el-tp-customer-details',
				'prefix_class' => '',
			)
		);
...
Plugin::instance()->widgets_manager->register( new Customer_Details() );
