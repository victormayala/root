<?php
/**
 * Loop Product Wishlist block attributes.
 *
 * @package woodmart
 */
...
if ( ! function_exists( 'wd_get_loop_builder_product_wishlist_attrs' ) ) {
	/**
	 * Get Loop Product Wishlist block attributes.
	 *
	 * @return array[]
	 */
	function wd_get_loop_builder_product_wishlist_attrs() {
