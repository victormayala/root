<?php
/**
 * Loop Product Compare block attributes
 *
 * @package woodmart
 */
...
if ( ! function_exists( 'wd_get_loop_builder_product_compare_attrs' ) ) {
	/**
	 * Get Loop Product Compare block attributes.
	 *
	 * @return array[]
	 */
	function wd_get_loop_builder_product_compare_attrs() {
