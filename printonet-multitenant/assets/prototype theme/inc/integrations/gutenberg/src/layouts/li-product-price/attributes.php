<?php
/**
 * Loop Product price block attributes.
 *
 * @package woodmart
 */
...
if ( ! function_exists( 'wd_get_loop_builder_product_price_attrs' ) ) {
	/**
	 * Get Loop Product Price block attributes.
	 *
	 * @return array[]
	 */
	function wd_get_loop_builder_product_price_attrs() {
