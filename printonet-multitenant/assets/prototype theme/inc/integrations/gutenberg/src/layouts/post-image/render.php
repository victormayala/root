<?php if ( ! function_exists( 'wd_gutenberg_single_post_image' ) ) {
	function wd_gutenberg_single_post_image( $block_attributes ) {
		...
		return woodmart_shortcode_single_post_image( $block_attributes );
	}
}
