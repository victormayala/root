...
if ( ! empty( $attrs['linesLimit'] ) ) {
	$block_css->add_css_rules(
		$block_selector,
		array(
			array(
				'attr_name' => 'linesClamp',
				'template'  => '--wd-line-count: {{value}};',
			),
		)
	);
