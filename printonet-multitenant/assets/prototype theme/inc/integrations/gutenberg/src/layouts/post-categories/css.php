...
$block_css->add_css_rules(
	$block_selector . ' .wd-post-cat.wd-style-with-bg',
	array(
		array(
			'attr_name' => 'bgCatsColorCode',
			'template'  => 'background-color: {{value}};',
		),
		array(
			'attr_name' => 'bgCatsColorVariable',
...
$block_css->merge_with( wd_get_block_typography_css( $block_selector . ' .wd-post-cat', $attrs, 'tp' ) );
