<?php if ( ! function_exists( 'wd_gutenberg_single_post_comments' ) ) {
	function wd_gutenberg_single_post_comments( $block_attributes ) {
		...
		return woodmart_shortcode_single_post_comments( $block_attributes );
	}
}
