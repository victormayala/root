<?php
/**
 * Loop Product Categories List attributes.
 *
 * @package woodmart
 */
...
if ( ! function_exists( 'wd_get_loop_builder_product_categories_attrs' ) ) {
	/**
	 * Get Loop Product Categories List block attributes.
	 *
	 * @return array[]
	 */
	function wd_get_loop_builder_product_categories_attrs() {
