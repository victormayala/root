<?php
/**
 * Loop Product Brands block attributes.
 *
 * @package woodmart
 */
...
if ( ! function_exists( 'wd_get_loop_builder_product_brands_attrs' ) ) {
	/**
	 * Get Loop Product Brands block attributes.
	 *
	 * @return array[]
	 */
	function wd_get_loop_builder_product_brands_attrs() {
